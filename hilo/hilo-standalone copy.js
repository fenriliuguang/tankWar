        ...
        _uploadProjectionTransform: function(force) {
            if (!this._projectionTransformElements || force) {
                this._projectionTransformElements = new Float32Array([
                    ...
                    0, -1 / this.canvasHalfHeight, 0, -1, 1, 1,
                ]);
            }
    ...
    var View = (function() {
        ...
        function doSATCheck(poly1, poly2, result) {
            var len1 = poly1.length,
                ...
                min1, max1, min2, max2, dot, overlap, normal = {
                    x: 0,
                    y: 0
                };
...
(function(window) {
    ...
    var BitmapText = Class.create( /** @lends BitmapText.prototype */ {
        ...
        setText: function(text) {
            ...
            var i, charStr, charGlyph, charObj, width = 0,
                height = 0,
                left = 0;
            for (i = 0; i < len; i++) {
...
(function(window) {
    ...
    var WebSound = {
        ...
        _normalizeSource: function(source) {
            var result = {};
            if (typeof source === 'string') result = {
                src: source
            };
